...
using Amrita.IdentityManager.Host.Pages;
using Amrita.IdentityManager.Host.Pages.Account.Logout;
...
public class LogoutPageModel : PageModel
{
    ...
    public LogoutPageModel(IIdentityServerInteractionService interaction, IEventService events, SignInManager<AmritaUser> signInManager)
    {
